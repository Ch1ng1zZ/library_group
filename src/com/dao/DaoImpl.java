...
public class DaoImpl implements Dao {
 ...
 @Override
    public List<Book> getAllBooks() {
        ...
        PreparedStatement ps = null;
        ResultSet rs = null;
        String sql = "select id,name,theme,author,page_count,amount,language,status from library_group.book";
        c = DbHelper.getConnection();
        if (c != null) {
            try {
                ps = c.prepareStatement(sql);
                ...
                while (rs.next()) {
                    ...
                    book.setAuthor(rs.getString("theme"));
                    book.setTheme(rs.getString("author"));
    ...
    Connection c = null;
    PreparedStatement ps = null;
     String sql = "insert into library_group.book(name,theme,author,page_count,amount,language)\n"
     + "values ('" +newBook.getName()+ "','" +newBook.getTheme()+ "','" +newBook.getAuthor()+ "','" +newBook.getPage_count()+ "','"+newBook.getAmount()+"','"+newBook.getLanguage()+ "')";
    c = DbHelper.getConnection();
        if (c!=null) {
            try {
                ps = c.prepareStatement(sql);
    ...
    public boolean updateBook(Book book) {
        ...
        Connection c = null;
        PreparedStatement ps = null;
        String sql = "update library_group.book\n" + "set name='" + book.getName() + "',author='" + book.getAuthor() + "',page_count=" + book.getPage_count() + ",theme='" + book.getTheme() + "',amount=" + book.getAmount() + " ,language='" + book.getLanguage() + "'\n"+
                "where id=" + book.getId() + "";
        c = DbHelper.getConnection();
        if (c != null) {
            try {
 ...
 public boolean updateBookByStatus(int selectedId) {
    ...
    public boolean deleteBook(int selectedId) {
        ...
        String sql = "delete from library_group.book\n"
                                      + "where id=" + selectedId + "";
        c = DbHelper.getConnection();
        if (c != null) {
            try {
